...
const OverviewPage = () => {
  ...
  const handleTransfer = () => {
    ...
    const transferAmount = withdrawableCash;
  ...
  return (
    <>
      <Navbar />
      <div style={{ width: "90%", margin: "auto", padding: "20px", backgroundColor: "#FFFDD0", borderRadius: "10px" }}>
        <h2 style={{ color: "#006400" }}>📊 Stock Market Overview</h2>

        {/* Balance Info */}
        <div style={{ marginBottom: "20px", color: "#006400" }}>
        ...
        <div style={{ marginBottom: "20px" }}>
          <button style={{ backgroundColor: "#006400", color: "white", marginRight: "10px", padding: "8px 15px", border: "none", borderRadius: "5px" }} onClick={() => setDays(5)}>5 Days</button>
          <button style={{ backgroundColor: "#006400", color: "white", marginRight: "10px", padding: "8px 15px", border: "none", borderRadius: "5px" }} onClick={() => setDays(10)}>10 Days</button>
          <button style={{ backgroundColor: "#006400", color: "white", marginRight: "10px", padding: "8px 15px", border: "none", borderRadius: "5px" }} onClick={() => setDays(20)}>20 Days</button>
          <button style={{ backgroundColor: "#228B22", color: "white", padding: "8px 15px", border: "none", borderRadius: "5px" }} onClick={() => setShowBreakdown(!showBreakdown)}>
            {showBreakdown ? "Hide Breakdown" : "View Breakdown"}
          </button>
          <button style={{ backgroundColor: "#228B22", color: "white", marginLeft: "10px", padding: "8px 15px", border: "none", borderRadius: "5px" }} onClick={() => setShowTransfer(!showTransfer)}>
        ...
        {/* Breakdown Section */}
        {showBreakdown && (
          <div style={{ marginTop: "20px", color: "#006400" }}>
        ...
        {showTransfer && (
          <div style={{ marginTop: "20px", color: "#006400" }}>
            ...
            <p>Choose wallet to transfer withdrawable cash (${withdrawableCash}):</p>
            <select
            ...
            <button style={{ backgroundColor: "#006400", color: "white", padding: "8px 15px", border: "none", borderRadius: "5px" }} onClick={handleTransfer}>Confirm Transfer</button>

            {transferMessage && (
              <p style={{ marginTop: "10px", color: "#228B22" }}>{transferMessage}</p>
            )}
          </div>
        )}
      </div>
